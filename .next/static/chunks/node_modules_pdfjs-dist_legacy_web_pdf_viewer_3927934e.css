/* [project]/node_modules/pdfjs-dist/legacy/web/pdf_viewer.css [app-client] (css) */
.messageBar {
  ...
  --message-bar-close-button-hover-bg-color: #15141a24;
  --message-bar-close-button-active-bg-color: #15141a36;
  --message-bar-close-button-focus-bg-color: #15141a12;
}

@media (prefers-color-scheme: dark) {
  .messageBar {
    --message-bar-close-button-hover-bg-color: #fbfbfe24;
    --message-bar-close-button-active-bg-color: #fbfbfe36;
    --message-bar-close-button-focus-bg-color: #fbfbfe12;
  }
}
...
#editorUndoBar {
  ...
  --message-bar-icon: url("../media/secondaryToolbarButton-documentProperties.284a3c46.svg");
  --message-bar-icon-color: #0060df;
  --message-bar-bg-color: #deeafc;
  --message-bar-fg-color: var(--text-primary-color);
  --message-bar-border-color: #00000014;
  --undo-button-bg-color: #15141a12;
  --undo-button-bg-color-hover: #15141a24;
  --undo-button-bg-color-active: #15141a36;
...
@media (prefers-color-scheme: dark) {
  #editorUndoBar {
    ...
    --message-bar-border-color: #ffffff14;
    --undo-button-bg-color: #ffffff14;
    --undo-button-bg-color-hover: #ffffff24;
    --undo-button-bg-color-active: #ffffff36;
...
.dialog {
  ...
  --dialog-shadow: 0 2px 14px 0 #3a394433;
  --text-primary-color: #15141a;
  ...
  --button-secondary-bg-color: #15141a12;
  --button-secondary-fg-color: var(--text-primary-color);
  --button-secondary-border-color: var(--button-secondary-bg-color);
  --button-secondary-active-bg-color: #15141a36;
  --button-secondary-active-fg-color: var(--button-secondary-fg-color);
  --button-secondary-active-border-color: var(--button-secondary-bg-color);
  --button-secondary-hover-bg-color: #15141a24;
...
@media (prefers-color-scheme: dark) {
  .dialog {
    ...
    --button-secondary-bg-color: #fbfbfe12;
    --button-secondary-active-bg-color: #fbfbfe36;
    --button-secondary-hover-bg-color: #fbfbfe24;
...
.show:is(:is(:is(:is(:is(.annotationEditorLayer :is(.freeTextEditor, .inkEditor, .stampEditor, .highlightEditor, .signatureEditor), .textLayer) .editToolbar) .buttons) .altText) .tooltip) {
  ...
  --alt-text-tooltip-shadow: 0px 2px 6px 0px #3a394433;
}
...
/*# sourceMappingURL=node_modules_pdfjs-dist_legacy_web_pdf_viewer_3927934e.css.map*/